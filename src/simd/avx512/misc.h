 ...
 */
NPY_FINLINE __m512i v__setr_epi8(
...
NPY_FINLINE __m512i v__setr_epi16(
...
NPY_FINLINE __m512d v__setr_pd(double i0, double i1, double i2, double i3,
...
#define v_setf_u64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_8(npy_int64, FILL, __VA_ARGS__))
#define v_setf_s64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_8(npy_int64, FILL, __VA_ARGS__))
...
#else
    NPY_FINLINE __m512i v_select_u8(__m512i mask, __m512i a, __m512i b)
