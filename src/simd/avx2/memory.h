...
#ifndef _V_SIMD_AVX2_MEMORY_H
#define _V_SIMD_AVX2_MEMORY_H
...
// aligned load
#define v_loada_f32 _mm256_load_ps
#define v_loada_f64 _mm256_load_pd
// stream load
#define v_loads_f32(PTR) \
    _mm256_castsi256_ps(_mm256_stream_load_si256((const __m256i*)(PTR)))
#define v_loads_f64(PTR) \
    _mm256_castsi256_pd(_mm256_stream_load_si256((const __m256i*)(PTR)))
// load lower part
#define v_loadl_f32(PTR) _mm256_castps128_ps256(_mm_loadu_ps(PTR))
#define v_loadl_f64(PTR) _mm256_castpd128_pd256(_mm_loadu_pd(PTR))
// unaligned store
#define v_store_f32 _mm256_storeu_ps
#define v_store_f64 _mm256_storeu_pd
// aligned store
#define v_storea_f32 _mm256_store_ps
#define v_storea_f64 _mm256_store_pd
// stream store
#define v_stores_f32 _mm256_stream_ps
#define v_stores_f64 _mm256_stream_pd
// store lower part
#define v_storel_f32(PTR, VEC) _mm_storeu_ps(PTR, _mm256_castps256_ps128(VEC))
#define v_storel_f64(PTR, VEC) _mm_storeu_pd(PTR, _mm256_castpd256_pd128(VEC))
// store higher part
#define v_storeh_f32(PTR, VEC) _mm_storeu_ps(PTR, _mm256_extractf128_ps(VEC, 1))
#define v_storeh_f64(PTR, VEC) _mm_storeu_pd(PTR, _mm256_extractf128_pd(VEC, 1))
/***************************
 * Non-contiguous Load
 ***************************/
//// 32
...
{ return _mm256_castsi256_ps(v_loadn_u32((const s_uint32*)ptr, stride)); }
//// 64
#if 0 // slower
...
{ return _mm256_castsi256_pd(v_loadn_u64((const s_uint64*)ptr, stride)); }
#endif
V_FINLINE v_f64 v_loadn_f64(const double *ptr, s_intp stride)
{
...
V_FINLINE v_u64 v_loadn_u64(const s_uint64 *ptr, s_intp stride)
{ return _mm256_castpd_si256(v_loadn_f64((const double*)ptr, stride)); }
V_FINLINE v_s64 v_loadn_s64(const s_int64 *ptr, s_intp stride)
{ return _mm256_castpd_si256(v_loadn_f64((const double*)ptr, stride)); }
/***************************
...
{ v_storen_s32((s_int32*)ptr, stride, _mm256_castps_si256(a)); }
//// 64
...
{ v_storen_f64((double*)ptr, stride, _mm256_castsi256_pd(a)); }
