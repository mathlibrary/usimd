...
#define v_cvt_f32_b32(BL) _mm512_castsi512_ps(v_cvt_u32_b32(BL))
...
#else
    #define v_cvt_b32_u32(A) _mm512_cmpneq_epu32_mask(A, _mm512_setzero_si512())
    #define v_cvt_b64_u64(A) _mm512_cmpneq_epu64_mask(A, _mm512_setzero_si512())
#endif
#define v_cvt_b32_s32 v_cvt_b32_u32
#define v_cvt_b64_s64 v_cvt_b64_u64
