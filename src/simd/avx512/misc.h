...
#define v_setf_u8(FILL, ...)  v__setr_epi8(V__SET_FILL_64(char, FILL, __VA_ARGS__))
#define v_setf_s8(FILL, ...)  v__setr_epi8(V__SET_FILL_64(char, FILL, __VA_ARGS__))
#define v_setf_u16(FILL, ...) v__setr_epi16(V__SET_FILL_32(short, FILL, __VA_ARGS__))
#define v_setf_s16(FILL, ...) v__setr_epi16(V__SET_FILL_32(short, FILL, __VA_ARGS__))
#define v_setf_u32(FILL, ...) v__setr_epi32(V__SET_FILL_16(int, FILL, __VA_ARGS__))
#define v_setf_s32(FILL, ...) v__setr_epi32(V__SET_FILL_16(int, FILL, __VA_ARGS__))
#define v_setf_u64(FILL, ...) v__setr_epi64(V__SET_FILL_8(s_int64, FILL, __VA_ARGS__))
#define v_setf_s64(FILL, ...) v__setr_epi64(V__SET_FILL_8(s_int64, FILL, __VA_ARGS__))
#define v_setf_f32(FILL, ...) v__setr_ps(V__SET_FILL_16(float, FILL, __VA_ARGS__))
