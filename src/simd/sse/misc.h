...
#ifndef _V_SIMD_SSE_MISC_H
#define _V_SIMD_SSE_MISC_H

// vector with zero lanes
#define v_zero_u8  _mm_setzero_si128
#define v_zero_s8  _mm_setzero_si128
#define v_zero_u16 _mm_setzero_si128
#define v_zero_s16 _mm_setzero_si128
#define v_zero_u32 _mm_setzero_si128
#define v_zero_s32 _mm_setzero_si128
#define v_zero_u64 _mm_setzero_si128
#define v_zero_s64 _mm_setzero_si128
#define v_zero_f32 _mm_setzero_ps
#define v_zero_f64 _mm_setzero_pd

// vector with a specific value set to all lanes
#define v_setall_u8(VAL)  _mm_set1_epi8((char)VAL)
#define v_setall_s8(VAL)  _mm_set1_epi8((char)VAL)
#define v_setall_u16(VAL) _mm_set1_epi16((short)VAL)
#define v_setall_s16(VAL) _mm_set1_epi16((short)VAL)
#define v_setall_u32(VAL) _mm_set1_epi32((int)VAL)
#define v_setall_s32(VAL) _mm_set1_epi32(VAL)
#if !defined(__x86_64__) && !defined(_M_X64)
    #define v_setall_u64(VAL) _mm_set_epi32((int)(VAL >> 32), (int)VAL, (int)(VAL >> 32), (int)VAL)
    #define v_setall_s64 v_setall_u64
#else
    #define v_setall_u64(VAL) _mm_set1_epi64x(VAL)
    #define v_setall_s64(VAL) _mm_set1_epi64x(VAL)
#endif
 ...
 */
V_FINLINE __m128i v__setr_epi8(
...
V_FINLINE __m128i v__setr_epi16(short i0, short i1, short i2, short i3, short i4, short i5,
                                     short i6, short i7)
{
    return _mm_setr_epi16(i0, i1, i2, i3, i4, i5, i6, i7);
}
V_FINLINE __m128i v__setr_epi32(int i0, int i1, int i2, int i3)
{
    return _mm_setr_epi32(i0, i1, i2, i3);
}
V_FINLINE __m128i v__setr_epi64(s_int64 i0, s_int64 i1)
{
    return _mm_set_epi64x(i1, i0);
}
V_FINLINE __m128 v__setr_ps(float i0, float i1, float i2, float i3)
{
    return _mm_setr_ps(i0, i1, i2, i3);
}
V_FINLINE __m128d v__setr_pd(double i0, double i1)
{
    return _mm_setr_pd(i0, i1);
}
#define v_setf_u8(FILL, ...)  v__setr_epi8(NPYV__SET_FILL_16(char, FILL, __VA_ARGS__))
#define v_setf_s8(FILL, ...)  v__setr_epi8(NPYV__SET_FILL_16(char, FILL, __VA_ARGS__))
#define v_setf_u16(FILL, ...) v__setr_epi16(NPYV__SET_FILL_8(short, FILL, __VA_ARGS__))
#define v_setf_s16(FILL, ...) v__setr_epi16(NPYV__SET_FILL_8(short, FILL, __VA_ARGS__))
#define v_setf_u32(FILL, ...) v__setr_epi32(NPYV__SET_FILL_4(int, FILL, __VA_ARGS__))
#define v_setf_s32(FILL, ...) v__setr_epi32(NPYV__SET_FILL_4(int, FILL, __VA_ARGS__))
#define v_setf_u64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_2(s_int64, FILL, __VA_ARGS__))
#define v_setf_s64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_2(s_int64, FILL, __VA_ARGS__))
#define v_setf_f32(FILL, ...) v__setr_ps(NPYV__SET_FILL_4(float, FILL, __VA_ARGS__))
#define v_setf_f64(FILL, ...) v__setr_pd(NPYV__SET_FILL_2(double, FILL, __VA_ARGS__))
...
// Per lane select
#ifdef V_HAVE_SSE41
    #define v_select_u8(MASK, A, B)  _mm_blendv_epi8(B, A, MASK)
    #define v_select_f32(MASK, A, B) _mm_blendv_ps(B, A, _mm_castsi128_ps(MASK))
    #define v_select_f64(MASK, A, B) _mm_blendv_pd(B, A, _mm_castsi128_pd(MASK))
#else
    V_FINLINE __m128i v_select_u8(__m128i mask, __m128i a, __m128i b)
    { return _mm_xor_si128(b, _mm_and_si128(_mm_xor_si128(b, a), mask)); }
    V_FINLINE __m128 v_select_f32(__m128i mask, __m128 a, __m128 b)
    { return _mm_xor_ps(b, _mm_and_ps(_mm_xor_ps(b, a), _mm_castsi128_ps(mask))); }
    V_FINLINE __m128d v_select_f64(__m128i mask, __m128d a, __m128d b)
...
#define v_reinterpret_u8_f32 _mm_castps_si128
#define v_reinterpret_u8_f64 _mm_castpd_si128
...
#define v_reinterpret_s8_f32 _mm_castps_si128
#define v_reinterpret_s8_f64 _mm_castpd_si128
...
#define v_reinterpret_u16_f32 _mm_castps_si128
#define v_reinterpret_u16_f64 _mm_castpd_si128
...
#define v_reinterpret_s16_f32 _mm_castps_si128
#define v_reinterpret_s16_f64 _mm_castpd_si128
...
#define v_reinterpret_u32_f32 _mm_castps_si128
#define v_reinterpret_u32_f64 _mm_castpd_si128
...
#define v_reinterpret_s32_f32 _mm_castps_si128
#define v_reinterpret_s32_f64 _mm_castpd_si128
...
#define v_reinterpret_u64_f32 _mm_castps_si128
#define v_reinterpret_u64_f64 _mm_castpd_si128
...
#define v_reinterpret_s64_f32 _mm_castps_si128
#define v_reinterpret_s64_f64 _mm_castpd_si128

#define v_reinterpret_f32_f32(X) X
#define v_reinterpret_f32_u8  _mm_castsi128_ps
#define v_reinterpret_f32_s8  _mm_castsi128_ps
#define v_reinterpret_f32_u16 _mm_castsi128_ps
#define v_reinterpret_f32_s16 _mm_castsi128_ps
#define v_reinterpret_f32_u32 _mm_castsi128_ps
#define v_reinterpret_f32_s32 _mm_castsi128_ps
#define v_reinterpret_f32_u64 _mm_castsi128_ps
#define v_reinterpret_f32_s64 _mm_castsi128_ps
#define v_reinterpret_f32_f64 _mm_castpd_ps

#define v_reinterpret_f64_f64(X) X
#define v_reinterpret_f64_u8  _mm_castsi128_pd
#define v_reinterpret_f64_s8  _mm_castsi128_pd
#define v_reinterpret_f64_u16 _mm_castsi128_pd
#define v_reinterpret_f64_s16 _mm_castsi128_pd
#define v_reinterpret_f64_u32 _mm_castsi128_pd
#define v_reinterpret_f64_s32 _mm_castsi128_pd
#define v_reinterpret_f64_u64 _mm_castsi128_pd
#define v_reinterpret_f64_s64 _mm_castsi128_pd
#define v_reinterpret_f64_f32 _mm_castps_pd
