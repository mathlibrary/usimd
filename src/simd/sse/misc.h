 ...
 */
NPY_FINLINE __m128i v__setr_epi8(
...
NPY_FINLINE __m128i v__setr_epi16(short i0, short i1, short i2, short i3, short i4, short i5,
                                     short i6, short i7)
{
    return _mm_setr_epi16(i0, i1, i2, i3, i4, i5, i6, i7);
}
NPY_FINLINE __m128i v__setr_epi32(int i0, int i1, int i2, int i3)
{
    return _mm_setr_epi32(i0, i1, i2, i3);
}
NPY_FINLINE __m128i v__setr_epi64(npy_int64 i0, npy_int64 i1)
{
    return _mm_set_epi64x(i1, i0);
}
NPY_FINLINE __m128 v__setr_ps(float i0, float i1, float i2, float i3)
{
    return _mm_setr_ps(i0, i1, i2, i3);
}
NPY_FINLINE __m128d v__setr_pd(double i0, double i1)
{
...
#define v_setf_u64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_2(npy_int64, FILL, __VA_ARGS__))
#define v_setf_s64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_2(npy_int64, FILL, __VA_ARGS__))
...
#else
    NPY_FINLINE __m128i v_select_u8(__m128i mask, __m128i a, __m128i b)
    { return _mm_xor_si128(b, _mm_and_si128(_mm_xor_si128(b, a), mask)); }
    NPY_FINLINE __m128 v_select_f32(__m128i mask, __m128 a, __m128 b)
    { return _mm_xor_ps(b, _mm_and_ps(_mm_xor_ps(b, a), _mm_castsi128_ps(mask))); }
    NPY_FINLINE __m128d v_select_f64(__m128i mask, __m128d a, __m128d b)
