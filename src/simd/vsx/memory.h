...
#ifndef _V_SIMD_VSX_MEMORY_H
#define _V_SIMD_VSX_MEMORY_H
...
// avoid aliasing rules
    ...
    V_FINLINE s_uint64 *v__ptr2u64(const T_PTR *ptr)
    { s_uint64 *ptr64 = (s_uint64*)ptr; return ptr64; }
#else
    V_FINLINE s_uint64 *v__ptr2u64(const void *ptr)
    { s_uint64 *ptr64 = (s_uint64*)ptr; return ptr64; }
#endif // __cplusplus

// load lower part
V_FINLINE v_u64 v__loadl(const void *ptr)
{
...
{ return (v_s32)v_loadn_u32((const s_uint32*)ptr, stride); }
V_FINLINE v_f32 v_loadn_f32(const float *ptr, s_intp stride)
{ return (v_f32)v_loadn_u32((const s_uint32*)ptr, stride); }
//// 64
...
{ v_storen_u32((s_uint32*)ptr, stride, (v_u32)a); }
...
{ v_storen_u64((s_uint64*)ptr, stride, (v_u64)a); }
