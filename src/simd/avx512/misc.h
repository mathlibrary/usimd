...
#ifndef _V_SIMD_AVX512_MISC_H
#define _V_SIMD_AVX512_MISC_H

// set all lanes to zero
#define v_zero_u8  _mm512_setzero_si512
#define v_zero_s8  _mm512_setzero_si512
#define v_zero_u16 _mm512_setzero_si512
#define v_zero_s16 _mm512_setzero_si512
#define v_zero_u32 _mm512_setzero_si512
#define v_zero_s32 _mm512_setzero_si512
#define v_zero_u64 _mm512_setzero_si512
#define v_zero_s64 _mm512_setzero_si512
#define v_zero_f32 _mm512_setzero_ps
#define v_zero_f64 _mm512_setzero_pd

// set all lanes to same value
#define v_setall_u8(VAL)  _mm512_set1_epi8((char)VAL)
#define v_setall_s8(VAL)  _mm512_set1_epi8((char)VAL)
#define v_setall_u16(VAL) _mm512_set1_epi16((short)VAL)
#define v_setall_s16(VAL) _mm512_set1_epi16((short)VAL)
#define v_setall_u32(VAL) _mm512_set1_epi32((int)VAL)
#define v_setall_s32(VAL) _mm512_set1_epi32(VAL)
#define v_setall_u64(VAL) _mm512_set1_epi64(VAL)
#define v_setall_s64(VAL) _mm512_set1_epi64(VAL)
 ...
 */
V_FINLINE __m512i v__setr_epi8(
...
{
    const char V_DECL_ALIGNED(64) data[64] = {
...
V_FINLINE __m512i v__setr_epi16(
...
{
    const short V_DECL_ALIGNED(64) data[32] = {
        i0,  i1,  i2,  i3,  i4,  i5,  i6,  i7,  i8,  i9,  i10, i11, i12, i13, i14, i15,
        i16, i17, i18, i19, i20, i21, i22, i23, i24, i25, i26, i27, i28, i29, i30, i31
    };
    return _mm512_load_si512((const void*)data);
...
V_FINLINE __m512i v__setr_epi32(
    int i0, int i1, int i2,  int i3,  int i4,  int i5,  int i6,  int i7,
    int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15)
{
    return _mm512_setr_epi32(i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15);
}
V_FINLINE __m512i v__setr_epi64(s_int64 i0, s_int64 i1, s_int64 i2, s_int64 i3,
                                     s_int64 i4, s_int64 i5, s_int64 i6, s_int64 i7)
{
    return _mm512_setr_epi64(i0, i1, i2, i3, i4, i5, i6, i7);
}

V_FINLINE __m512 v__setr_ps(
...
V_FINLINE __m512d v__setr_pd(double i0, double i1, double i2, double i3,
                                  double i4, double i5, double i6, double i7)
{
    return _mm512_setr_pd(i0, i1, i2, i3, i4, i5, i6, i7);
}
#define v_setf_u8(FILL, ...)  v__setr_epi8(NPYV__SET_FILL_64(char, FILL, __VA_ARGS__))
#define v_setf_s8(FILL, ...)  v__setr_epi8(NPYV__SET_FILL_64(char, FILL, __VA_ARGS__))
#define v_setf_u16(FILL, ...) v__setr_epi16(NPYV__SET_FILL_32(short, FILL, __VA_ARGS__))
#define v_setf_s16(FILL, ...) v__setr_epi16(NPYV__SET_FILL_32(short, FILL, __VA_ARGS__))
#define v_setf_u32(FILL, ...) v__setr_epi32(NPYV__SET_FILL_16(int, FILL, __VA_ARGS__))
#define v_setf_s32(FILL, ...) v__setr_epi32(NPYV__SET_FILL_16(int, FILL, __VA_ARGS__))
#define v_setf_u64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_8(s_int64, FILL, __VA_ARGS__))
#define v_setf_s64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_8(s_int64, FILL, __VA_ARGS__))
#define v_setf_f32(FILL, ...) v__setr_ps(NPYV__SET_FILL_16(float, FILL, __VA_ARGS__))
#define v_setf_f64(FILL, ...) v__setr_pd(NPYV__SET_FILL_8(double, FILL, __VA_ARGS__))
...
// per lane select
    ...
    #define v_select_u8(MASK, A, B)  _mm512_mask_blend_epi8(MASK,  B, A)
    #define v_select_u16(MASK, A, B) _mm512_mask_blend_epi16(MASK, B, A)
#else
    V_FINLINE __m512i v_select_u8(__m512i mask, __m512i a, __m512i b)
...
#define v_select_s16 v_select_u16
#define v_select_u32(MASK, A, B) _mm512_mask_blend_epi32(MASK, B, A)
#define v_select_s32 v_select_u32
#define v_select_u64(MASK, A, B) _mm512_mask_blend_epi64(MASK, B, A)
#define v_select_s64 v_select_u64
#define v_select_f32(MASK, A, B) _mm512_mask_blend_ps(MASK, B, A)
#define v_select_f64(MASK, A, B) _mm512_mask_blend_pd(MASK, B, A)
...
#define v_reinterpret_u8_f32 _mm512_castps_si512
#define v_reinterpret_u8_f64 _mm512_castpd_si512
...
#define v_reinterpret_s8_f32 _mm512_castps_si512
#define v_reinterpret_s8_f64 _mm512_castpd_si512
...
#define v_reinterpret_u16_f32 _mm512_castps_si512
#define v_reinterpret_u16_f64 _mm512_castpd_si512
...
#define v_reinterpret_s16_f32 _mm512_castps_si512
#define v_reinterpret_s16_f64 _mm512_castpd_si512
...
#define v_reinterpret_u32_f32 _mm512_castps_si512
#define v_reinterpret_u32_f64 _mm512_castpd_si512
...
#define v_reinterpret_s32_f32 _mm512_castps_si512
#define v_reinterpret_s32_f64 _mm512_castpd_si512
...
#define v_reinterpret_u64_f32 _mm512_castps_si512
#define v_reinterpret_u64_f64 _mm512_castpd_si512
...
#define v_reinterpret_s64_f32 _mm512_castps_si512
#define v_reinterpret_s64_f64 _mm512_castpd_si512

#define v_reinterpret_f32_f32(X) X
#define v_reinterpret_f32_u8  _mm512_castsi512_ps
#define v_reinterpret_f32_s8  _mm512_castsi512_ps
#define v_reinterpret_f32_u16 _mm512_castsi512_ps
#define v_reinterpret_f32_s16 _mm512_castsi512_ps
#define v_reinterpret_f32_u32 _mm512_castsi512_ps
#define v_reinterpret_f32_s32 _mm512_castsi512_ps
#define v_reinterpret_f32_u64 _mm512_castsi512_ps
#define v_reinterpret_f32_s64 _mm512_castsi512_ps
#define v_reinterpret_f32_f64 _mm512_castpd_ps

#define v_reinterpret_f64_f64(X) X
#define v_reinterpret_f64_u8  _mm512_castsi512_pd
#define v_reinterpret_f64_s8  _mm512_castsi512_pd
#define v_reinterpret_f64_u16 _mm512_castsi512_pd
#define v_reinterpret_f64_s16 _mm512_castsi512_pd
#define v_reinterpret_f64_u32 _mm512_castsi512_pd
#define v_reinterpret_f64_s32 _mm512_castsi512_pd
#define v_reinterpret_f64_u64 _mm512_castsi512_pd
#define v_reinterpret_f64_s64 _mm512_castsi512_pd
#define v_reinterpret_f64_f32 _mm512_castps_pd

#ifdef V_HAVE_AVX512_KNL
    #define v_cleanup() ((void)0)
#else
    #define v_cleanup _mm256_zeroall
#endif

#endif // _V_SIMD_AVX512_MISC_H
