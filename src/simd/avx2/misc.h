...
*/
NPY_FINLINE __m256i v__setr_epi8(
...
NPY_FINLINE __m256i v__setr_epi16(
...
NPY_FINLINE __m256i v__setr_epi32(int i0, int i1, int i2, int i3, int i4, int i5, int i6, int i7)
{
    return _mm256_setr_epi32(i0, i1, i2, i3, i4, i5, i6, i7);
}
NPY_FINLINE __m256i v__setr_epi64(npy_int64 i0, npy_int64 i1, npy_int64 i2, npy_int64 i3)
{
    return _mm256_setr_epi64x(i0, i1, i2, i3);
}

NPY_FINLINE __m256 v__setr_ps(float i0, float i1, float i2, float i3, float i4, float i5,
                                 float i6, float i7)
{
    return _mm256_setr_ps(i0, i1, i2, i3, i4, i5, i6, i7);
}
NPY_FINLINE __m256d v__setr_pd(double i0, double i1, double i2, double i3)
{
    return _mm256_setr_pd(i0, i1, i2, i3);
}
#define v_setf_u8(FILL, ...)  v__setr_epi8(NPYV__SET_FILL_32(char, FILL, __VA_ARGS__))
#define v_setf_s8(FILL, ...)  v__setr_epi8(NPYV__SET_FILL_32(char, FILL, __VA_ARGS__))
#define v_setf_u16(FILL, ...) v__setr_epi16(NPYV__SET_FILL_16(short, FILL, __VA_ARGS__))
#define v_setf_s16(FILL, ...) v__setr_epi16(NPYV__SET_FILL_16(short, FILL, __VA_ARGS__))
#define v_setf_u32(FILL, ...) v__setr_epi32(NPYV__SET_FILL_8(int, FILL, __VA_ARGS__))
#define v_setf_s32(FILL, ...) v__setr_epi32(NPYV__SET_FILL_8(int, FILL, __VA_ARGS__))
#define v_setf_u64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_4(npy_uint64, FILL, __VA_ARGS__))
#define v_setf_s64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_4(npy_int64, FILL, __VA_ARGS__))
#define v_setf_f32(FILL, ...) v__setr_ps(NPYV__SET_FILL_8(float, FILL, __VA_ARGS__))
#define v_setf_f64(FILL, ...) v__setr_pd(NPYV__SET_FILL_4(double, FILL, __VA_ARGS__))
