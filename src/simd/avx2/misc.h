...
#define v_setf_u64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_4(s_uint64, FILL, __VA_ARGS__))
#define v_setf_s64(FILL, ...) v__setr_epi64(NPYV__SET_FILL_4(s_int64, FILL, __VA_ARGS__))
