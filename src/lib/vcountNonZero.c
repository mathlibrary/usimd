...
int usimd_countNonZero(uchar *d, size_t n)
{
    ...
    while (i < unrollx)
    {
        ...
        int j = i;
        while (j < MIN(unrollx, i + 65535 * v_nlanes_u16))
        {
            int k = j;
            ...
            v_u16 part1, part2;
            v_expand_u8_u16(vsum8, &part1, &part2);
            vsum16 = v_add_u16(vsum16, v_add_u16(part1, part2));
            j = k;
        }
        v_u32 part1, part2;
        v_expand_u16_u32(vsum16, &part1, &part2);
        vsum32 = v_add_u32(vsum32, v_add_u32(part1, part2));
        i = j;
    }
