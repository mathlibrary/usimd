...
// load lower part
#define v_loadl_f32(PTR) _mm_castsi128_ps(v_loadl_u32((const npy_uint32*)(PTR)))
#define v_loadl_f64(PTR) _mm_castsi128_pd(v_loadl_u32((const npy_uint32*)(PTR)))
// stream load
...
// store higher part
#define v_storeh_f32(PTR, VEC) v_storeh_u32((npy_uint32*)(PTR), _mm_castps_si128(VEC))
#define v_storeh_f64(PTR, VEC) v_storeh_u32((npy_uint32*)(PTR), _mm_castpd_si128(VEC))
/***************************
 * Non-contiguous Load
 ***************************/
//// 32
...
{ return v_loadn_s32((const npy_int32*)ptr, stride); }
NPY_FINLINE v_f32 v_loadn_f32(const float *ptr, npy_intp stride)
{ return _mm_castsi128_ps(v_loadn_s32((const npy_int32*)ptr, stride)); }
//// 64
...
{ v_storen_s32((npy_int32*)ptr, stride, _mm_castps_si128(a)); }
//// 64
